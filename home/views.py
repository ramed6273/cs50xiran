    ...
    for customer in order.customers.all():
        payload = {
            ...
            "message": customer.firstname + " عزیز" + '\n\n'
                    ...
                    "برای ورود روی لینک زیر زده. نام کاربری ایمیل و رمزعبور شماره موبایل‌تان است. فرایند دسترسی به پنل کاربری ممکن است 1 تا 2 ساعت زمان ببرد. از صبر و شکیبایی شما سپاسگزاریم." + '\n\n'
                    "cs50x.ir" + '\n\n',
