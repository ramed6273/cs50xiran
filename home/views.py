    ...
    for customer in order.customers.all():
        payload = {
            ...
            "message": customer.firstname + " عزیز" + '\n\n'
                    ...
                    "برای ورود روی لینک زیر زده. نام کاربری ایمیل و رمزعبور شماره موبایل‌تان است. " + '\n\n'
                    "فرایند دسترسی به پنل کاربری ممکن است 1 تا 2 ساعت زمان ببرد." + '\n\n'
        ...
        if password_reset_form.is_valid():
            ...
            if associated_users.exists():
                for user in associated_users:
                    subject = "درخواست تغییر رمزعبور | CS50x Iran"
